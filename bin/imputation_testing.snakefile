...
#Testing for three different imputation references

#All that should need to happen is remove testing animals from each of these references
...
# rule bigref_phasing:
# 	input:
# 		refvcf = expand("reference_build/{ref_version}/{reference}/vcf_per_assay/{ref}.chr{{chr}}.vcf.gz",
# 		ref = config["hdref"],
# 		ref_version = config["ref_version"]),
